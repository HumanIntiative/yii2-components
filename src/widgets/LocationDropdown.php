...
class LocationDropdown extends Widget
{
    ...
    /**
     * @var bool $useAddress If you want to use address input
     */
    public $useAddress = true;
    /**
     * @var bool $useSubdistrict If you want to use sub-district input
     */
    public $useSubdistrict = true;
    /**
     * @var bool $useVillage If you want to use village input
     */
    public $useVillage = true;
    /**
    ...
    public function prepareData()
    {
        ...
        $this->dataLocation3 = [];
        if (!empty($val_attr2) && $this->useSubdistrict) {
        ...
        $this->dataLocation4 = [];
        if (!empty($val_attr3) && $this->useVillage) {
    ...
    protected function textAddress()
    {
        $textArea = null;
        if ($this->useAddress) {
            $textArea = Html::beginTag('div', ['style'=>'padding-top:5px;']) .
                    $this->addressLabel .
    ...
    {
        $dropdown = null;
        if ($this->useSubdistrict) {
            $dropdown = Html::beginTag('div', ['class'=>'padding-top:5px;']) .
